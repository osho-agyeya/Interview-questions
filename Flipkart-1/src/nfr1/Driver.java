...
public class Driver {
	...
	public boolean bookslot(User user, Centre centre) {
		if(user.preferredVaccineType.equals("COVAX") && centre.getCovaxQuantity()>=1)
			{
			centre.setCovaxQuantity(centre.getCovaxQuantity()-1);
			centre.addAssignedUsers(user);
			user.setAssignedCentre(centre);
			return true;
			}
		else if(user.preferredVaccineType.equals("COVIDSHIELD") && centre.getCovidshieldQuantity()>=1)
		{
	...
	public static void main(String[] args) {
		...
		System.out.println(driver.bookslot(User2, Centre2));
		System.out.println(driver.bookslot(User1, Centre1));
